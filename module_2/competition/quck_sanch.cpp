// STUDENT's SOLUTION APPENDED AT THE END OF COMMON HEADER
#include <cstring>
#include <memory>
#include <iostream>
#include <stdlib.h>
...
template<typename T>
void smartPartitionQuickSort(T *arr, long p, long r)
{
    if(r-p <= 138)
    {
        simpleInsertionSort<T>(arr, p, r);
        return;
    }
...
void sort(BlackInt *begin, BlackInt *end){
    ...
    smartPartitionQuickSort<BlackInt>(begin, 0, size-1);
}